...
Composite:
$$\log(TotalProduction_{ij}) = \alpha + \beta yrsince1998_{ij} + \gamma\log(priceperlb)_{ij} + \delta\log(clothianidin_{ij}) + \lambda\log(acetamiprid_{ij}) + $$
...
>>>>>>> 07de0ca2f1fee2c6250a6070f356d4a2182ed1cf
